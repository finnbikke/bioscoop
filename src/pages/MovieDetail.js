...
export const MovieDetail = () => {
  ...
  useEffect (() => {
    ...
    const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=f9fcd20391f00b6198b8e46b583d8ef4&language=en-US`);
        ...
        <section className="flex justify-around flex-wrap py-5">
          ...
          <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
            ...
            <p className="my-4">
              ...
              <span>{movie.revenue} euros</span>
            </p>

            <p className="my-4">
              <span className="mr-2 font-bold"> Budget:</span>
              <span>{movie.budget} euros </span>
            </p>
